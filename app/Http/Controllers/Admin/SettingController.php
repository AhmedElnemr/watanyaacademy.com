...
/*  public function __construct()
  {
      $this->middleware('permission:setting_show'   , ['only' => 'setting_page', 'operate_page', 'send_settings', 'settings_site_text']);
      $this->middleware('permission:setting_edit'   , ['only' => 'send_settings', 'site_text_edit','site_text_update']);
    ...
    public function send_settings(Request $request)
	{
        ...
        $validator = Validator::make($request->all(),[
            ...
            'web_site_name'         => 'nullable',
            'ar_termis_condition'   => 'nullable',
            'counter_open_course'   => 'nullable',
            'counter_course'   => 'nullable',
            'counter_student'   => 'nullable',
            'counter_teacher'   => 'nullable',
            'out_account'   => 'nullable',
            'eg_account'   => 'nullable',
        ...
        if (request()->fave_icon != '') {
            $data['fave_icon']  = upload_image('setting',request()->footer_logo, 1, 'fave_icon');
        }
        if (request()->image_slider != '') {
            $data['image_slider']  = upload_image('setting',request()->footer_logo, 1, 'image_slider');
        }
