...
class SiteTextDatatable extends DataTable {



    public function dataTable($query) {
        return datatables($query)
            ->addColumn('edit', 'admin.site_texts.btn.edit')
            ->addColumn('checkbox', 'admin.site_texts.btn.checkbox')
            ->addColumn('delete', 'admin.site_texts.btn.delete')
         /*   ->addColumn('img', 'admin.site_texts.btn.img')*/
            ->rawColumns([
                'edit',
                'checkbox',
                'delete',
    ...
    public function html() {
        return $this->builder()
            ...
            ->parameters([
                // 'responsive' => true,
                'dom'        => 'Blfrtip',
                'lengthMenu' => [[20, 25, 50, 100], [20, 25, 50, trans('admin.all_record')]],
                "pageLength"=> 50,
                'buttons'    => [
