...
class ActivityDepartmentDatatable extends DataTable {



    public function dataTable($query) {
        return datatables($query)
            ->addColumn('edit', 'admin.activity_departments.btn.edit')
            ->addColumn('checkbox', 'admin.activity_departments.btn.checkbox')
            ->addColumn('delete', 'admin.activity_departments.btn.delete')
            ->rawColumns([
                'edit',
                'checkbox',
                'delete',
    ...
    {
        return ActivityDepartment::query();
    }
...
//                    ['extend' => 'pdf', 'className' => 'btn btn-info btn_space', 'text' => 'PDF <i class="fa fa-file"></i> '],
    ...
    protected function filename() {
        return 'activity_department_'.date('YmdHis');
    }
