...
class ActivityDatatable extends DataTable {
    ...
    public function dataTable($query) {
        return datatables($query)
            ->addColumn('edit', 'admin.activitys.btn.edit')
            ->addColumn('checkbox', 'admin.activitys.btn.checkbox')
            ->addColumn('delete', 'admin.activitys.btn.delete')
            ->addColumn('img', 'admin.activitys.btn.img')
            ->rawColumns([
                'edit',
                'checkbox',
                'delete',
    ...
    {
        return Activity::query()->with('activity_department_fk');
    }
    ...
    protected function getColumns() {
        ...
        $data = [
            ...
            , [
                ...
                'name'  => 'activity_department_fk.title',
                'data'  => 'activity_department_fk.title',
                'title' => 'القسم',
            ],
            [
                'name'       => 'edit',
