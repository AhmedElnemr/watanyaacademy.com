...
$first_title   = ["title"=> $ti, "url"=> aurl('site_text') ];
...
{{--                <a href="{{ aurl('site_text/create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">--}}
{{--          <span>--}}
{{--            <i class="la la-plus"></i>--}}
{{--            <span>اضافة مستوى جديد</span>--}}
{{--          </span>--}}
{{--                </a>--}}
{{--            </div>--}}
        ...
        <div class="box-body table-responsive text-nowrap bg_color">
            {!! Form::open(['id'=>'form_data','route' => 'delete_all_site_text', 'method' => 'delete']) !!}
