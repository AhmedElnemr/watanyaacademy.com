...
$first_title   = ["title"=>$title, "url"=> aurl('site_text') ];
$secind_title  = ["title"=>$title , "url"=> aurl('site_text/create') ];
?>
...
@section('content')
    ...
    <div class="box">
        ...
        {!! Form::open( ['route' => 'site_text.store',  'method' => 'POST','files'=>true] ) !!}
