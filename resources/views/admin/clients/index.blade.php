...
$first_title   = ["title"=> $ti, "url"=> aurl('client') ];
    ...
    <div class="box">
        <div class="box-header row">
            ...
            <div class="col-md-2 col-sm-4 col-xs-12" >
                <a href="{{ aurl('client/create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
                  <span>
        ...
        <div class="box-body table-responsive text-nowrap bg_color">
            {!! Form::open(['id'=>'form_data','route' => 'delete_all_client', 'method' => 'delete']) !!}
