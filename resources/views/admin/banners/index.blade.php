...
$first_title   = ["title"=> $ti, "url"=> aurl('banner') ];
...
{{--                <a href="{{ aurl('banner/create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">--}}
{{--          <span>--}}
...
{{--            </div>--}}
        ...
        <div class="box-body table-responsive text-nowrap bg_color">
            {!! Form::open(['id'=>'form_data','route' => 'delete_all_banner', 'method' => 'delete']) !!}
