...
$first_title   = ["title"=> $ti, "url"=> aurl('activity') ];
    ...
    <div class="box">
        <div class="box-header row">
            ...
            <div class="col-md-2 col-sm-4 col-xs-12" >
                <a href="{{ aurl('activity/create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
          <span>
            <i class="la la-plus"></i>
            <span>اضافة نشاط جديد </span>
          </span>
                </a>
            </div>
        ...
        <div class="box-body table-responsive text-nowrap bg_color">
            {!! Form::open(['id'=>'form_data','route' => 'delete_all_activity', 'method' => 'delete']) !!}
