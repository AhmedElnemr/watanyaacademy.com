...
<?php
$home_title    = trans('admin.main_name' ) . ' | ' . trans('admin.edit_', ['name_value'=> $activity->title] );
$first_title   = ["title"=>' الانشطة' , "url"=> aurl('activity') ];
$secind_title  = ["title"=> trans('admin.edit_', ['name_value'=> $activity->title] ) , "url"=> '' ];
?>
...
@section('content')
    ...
    <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            {!! Form::open( ['route' => ['activity.update', $activity->id], 'method' => 'put', 'files'=>true]  ) !!}
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    {!! Form::select('activity_department_id', App\Models\ActivityDepartment::pluck('title','id'), $activity->activity_department_id ,
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="file" name="main_image" id="input-file-now-custom-1" class="dropify"
                           data-default-file="{{ GetImg( $activity->main_image ) }}">
                </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    {!! Form::textarea('contents', $activity->contents ,['class'=>'form-control']) !!}
                </div>
                ...
                <div class="form-group m-form__group col-xl-12 col-lg-12 contentPreviewImg quote-imgs-thumbs quote-imgs-thumb">
                    ...
                    <div class="quote-imgs-thumbs quote-imgs-thumb " id="img_preview" aria-live="polite">
                            ...
                            @foreach($activity->images_fk()->get() as $image)
                                <span class="position-relative">
                                   <span class="xSpan delete_img" id="{{ $image->id }}">x</span>
...
@push('js')
    ...
    <script !src="">
        ...
        $(document).on('click', '.delete_img', function(){
            ...
            var id = $(this).attr('id');
            var url   = '{{ route('delete_img_activity') }}';
