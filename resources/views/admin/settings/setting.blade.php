    ...
    <div class="box">
        ...
        <!-- /.box-header -->
            <div class="box-body">
                ...
                <br><br>
                <hr>
                <h3 class="text-center bg-setting"> الصور </h3>
                <hr>
                <br><br>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        {!! Form::label('footer_logo', '*صورة الايقونة' ) !!}
                        <input data-validation-allowing="image/*"  type="file" name="fave_icon" id="input-file-now-custom-1" class="dropify"
                               data-default-file="{{url('storage/').'/'. setting()->fave_icon }}">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        {!! Form::label('login_banner', '*صورة لوجو الموقع ' ) !!}
                        <input data-validation-allowing="image/*"  type="file" name="image_slider" id="input-file-now-custom-1" class="dropify"
                               data-default-file="{{url('storage/').'/'. setting()->image_slider }}">
                        <span style="color: red"> مقاس الصورة يجب ان يكون (W 250 * H 60) </span>
                    </div>
                ...
                <br><br>
                <hr>
                <h3 class="text-center bg-setting"> أرقام الحساب   </h3>
                <hr>
                <br><br>

                <div class="row">
                    <div class="form-group col-md-6">
                        {!! Form::label('eg_account', 'رقم الحساب داخل مصر ' ) !!}
                        {!! Form::text('eg_account',setting()->eg_account,['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group col-md-6">
                        {!! Form::label('out_account', 'رقم الحساب خارج مصر ' ) !!}
                        {!! Form::text('out_account',setting()->out_account,['class'=>'form-control']) !!}
                    </div>
                </div>
                ...
                <br><br>
                <hr>
                <h3 class="text-center bg-setting"> الاحصائيات  </h3>
                <hr>
                <br><br>

                <div class="row">
                    <div class="form-group col-md-6">
                        {!! Form::label('counter_open_course', 'كورسات المفتوحة*' ) !!}
                        {!! Form::number('counter_open_course',setting()->counter_open_course,['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group col-md-6">
                        {!! Form::label('counter_course', 'البرامج التعليمية*' ) !!}
                        {!! Form::number('counter_course',setting()->counter_course,['class'=>'form-control']) !!}
                    </div>
                </div>

                <div class="row">
                    <div class="form-group col-md-6">
                        {!! Form::label('counter_student', 'الطلاب *' ) !!}
                        {!! Form::number('counter_student',setting()->counter_student,['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group col-md-6">
                        {!! Form::label('counter_teacher', 'أعضاء هيئة تدريس*' ) !!}
                        {!! Form::number('counter_teacher',setting()->counter_teacher,['class'=>'form-control']) !!}
                    </div>
                </div>
