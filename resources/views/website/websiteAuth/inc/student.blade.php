<div class="tab-pane fade show active" id="student-md" role="tabpanel" aria-labelledby="student-tab-md">
    ...
    <form action="{{url('register')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <input  class="form-control" name="name" type="text" placeholder=" اسم الطالب " required>
            </div>
